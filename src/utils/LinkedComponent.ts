import {
  ...
  QueryWrapperObject,
  SelectQuery,
  ToQueryResultSet,onQueriesReady,
...
export interface LinkedComponent<P, ShapeType extends Shape = Shape,ResultType=any>
  extends React.FC<
...
export type LinkedSetComponentFactoryFn = <
  QueryType extends SelectQueryFactory<any> | {[key: string]: SelectQueryFactory<any>} = null,
  CustomProps = {},
...
export function createLinkedSetComponentFn(
  ...
  >(
    ...
    let [shapeClass, actualQuery] = processQuery<ShapeType>(
      query,
      true,
    );
