...
describe('query tests', () => {
  ...
  test('component requesting data from child components', async () => {
    ...
    let query2 = Person.query((p) => {
      ...
      // let res = {
      //   hobby: p.hobby,
      //   bestFriend: p.bestFriend.renderedAs(Component1),
      // };
      return res;
    });

    //How to turn this
    // BoundComponent<QShape<Person, Person, "bestFriend">,Person>
    // (QShape<ShapeType,Source,Property>)
    //->> Person.bestFriend is a Person
    //--> Source.Property is a ShapeType
    //--> QResult<Source,{Property: ShapeType}>
    //into a QResult<Person, {bestFriend: QResult<Person>}>
